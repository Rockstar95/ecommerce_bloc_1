...
import 'package:ecommerce_bloc_1/constants/styles.dart';
...
class AppTheme {
  ...
  static TextStyle getTextStyle(TextStyle textStyle,
    ...
    Color finalColor;
    if(color==null) {
      finalColor= (xMuted ? textStyle.color?.withAlpha(160) : (muted ? textStyle.color?.withAlpha(200) : textStyle.color)) ?? Styles.primaryColor;
    }
    else {
  ...
  static final TextTheme lightAppBarTextTheme = TextTheme(
    headline1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 102, color: const Color(0xff495057))),
    headline2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 64, color: const Color(0xff495057))),
    headline3: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 51, color: const Color(0xff495057))),
    headline4: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 36, color: const Color(0xff495057))),
    headline5: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 25, color: const Color(0xff495057))),
    headline6: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 18, color: const Color(0xff495057))),
    subtitle1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 17, color: const Color(0xff495057))),
    ...
    bodyText1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 16, color: const Color(0xff495057))),
    bodyText2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 14, color: const Color(0xff495057))),
    button: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 15, color: const Color(0xff495057))),
    caption: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 13, color: const Color(0xff495057))),
    overline: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 11, color: const Color(0xff495057))),
  );

  static final TextTheme darkAppBarTextTheme = TextTheme(
    headline1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 102, color: const Color(0xffffffff))),
    headline2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 64, color: const Color(0xffffffff))),
    headline3: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 51, color: const Color(0xffffffff))),
    headline4: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 36, color: const Color(0xffffffff))),
    headline5: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 25, color: const Color(0xffffffff))),
    headline6: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 20, color: const Color(0xffffffff))),
    subtitle1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 17, color: const Color(0xffffffff))),
    subtitle2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 15, color: const Color(0xffffffff))),
    bodyText1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 16, color: const Color(0xffffffff))),
    bodyText2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 14, color: const Color(0xffffffff))),
    button: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 15, color: const Color(0xffffffff))),
    caption: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 13, color: const Color(0xffffffff))),
    overline: GoogleFonts.ibmPlexSans(
  ...
  static final TextTheme lightTextTheme = TextTheme(
    headline1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 102, color: const Color(0xff4a4c4f))),
    headline2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 64, color: const Color(0xff4a4c4f))),
    headline3: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 51, color: const Color(0xff4a4c4f))),
    headline4: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 36, color: Color(0xff4a4c4f))),
    headline5: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 25, color: Color(0xff4a4c4f))),
    headline6: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 18, color: const Color(0xff4a4c4f))),
    subtitle1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 17, color: const Color(0xff4a4c4f))),
    subtitle2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 15, color: const Color(0xff4a4c4f))),
    bodyText1: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 16, color: const Color(0xff4a4c4f))),
    bodyText2: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 14, color: const Color(0xff4a4c4f))),
    button: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 15, color: const Color(0xff4a4c4f))),
    caption: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 13, color: Color(0xff4a4c4f))),
    overline: GoogleFonts.ibmPlexSans(
        textStyle: const TextStyle(fontSize: 11, color: const Color(0xff4a4c4f))),
  );
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      toolbarTextStyle: GoogleFonts.ibmPlexSans(textStyle: const TextStyle(fontSize: 16, color: Styles.primaryColor)),
      titleTextStyle: GoogleFonts.ibmPlexSans(textStyle: const TextStyle(fontSize: 16, color: Styles.primaryColor)),
    ...
    navigationRailTheme: const NavigationRailThemeData(
        selectedIconTheme:
        IconThemeData(color: Styles.primaryColor, opacity: 1, size: 24),
        unselectedIconTheme:
        IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: const TextStyle(color: Styles.primaryColor),
        unselectedLabelTextStyle: const TextStyle(color: const Color(0xff495057))),
    colorScheme: ColorScheme.light(
        primary: Styles.primaryColor,
        onPrimary: Colors.white,
        primaryVariant: Styles.primaryColor.withOpacity(0.4),
        secondary: Styles.secondaryColor,
        secondaryVariant: Styles.secondaryColor.withOpacity(0.4),
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Styles.primaryColor),
      ),
    ...
    popupMenuTheme: PopupMenuThemeData(
      color: const Color(0xffffffff),
      textStyle: lightTextTheme.bodyText2?.merge(const TextStyle(color: const Color(0xff495057))),
    ),
    bottomAppBarTheme: const BottomAppBarTheme(color: const Color(0xffffffff), elevation: 2),
    ...
    sliderTheme: SliderThemeData(
      ...
      inactiveTrackColor: Styles.primaryColor.withAlpha(140),
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      popupMenuTheme: PopupMenuThemeData(
        ...
        textStyle: lightTextTheme.bodyText2?.merge(const TextStyle(color: const Color(0xffffffff))),
      ),
      ...
      tabBarTheme: const TabBarTheme(
        ...
        indicator: const UnderlineTabIndicator(
          borderSide: const BorderSide(color: Color(0xff10bbf0), width: 2.0),
        ),
      ),
      sliderTheme: SliderThemeData(
        activeTrackColor: const Color(0xff10bbf0),
        inactiveTrackColor: Styles.primaryColor.withAlpha(100),
        trackShape: const RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
